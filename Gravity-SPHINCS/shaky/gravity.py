...
from shaky.common import GRAVITY_ccc, GRAVITY_d, GRAVITY_c, MERKLE_hhh, GRAVITY_OK, MERKLE_h, GRAVITY_ERR_VERIF, \
    HASH_SIZE, WOTS_ell
from shaky.merkle import MerklePK, merkle_genpk, merkle_sign, merkle_extract, merkle_compress_auth
...
class GravitySign:
    def __init__(self):
        self.rand = None  # hash
        self.op_sign = None  # OctoporstSign
        self.merkle = [None for _ in range(GRAVITY_d)]  # [MerkleSign]
        self.auth = [None for _ in range(GRAVITY_c)]  # [Hash]
...
def gravity_genpk(sk: GravitySK, pk: GravityPK) -> int:
    pk.k = sk.cache[2 * GRAVITY_ccc - 2].h.copy()
    return GRAVITY_OK
...
def gravity_gensk_test():
    if GRAVITY_c != 1 and GRAVITY_c != 3:
        raise Exception("To run this test set GRAVITY_c to 1 or 3 fot this test")
    k = GravitySK(Hash([i for i in range(32)]))
    gravity_gensk(k)
    expected_1 = "20b97e26ac1c97d2cba431e1c75a6909b743bb7cf260dc076929e2a842ffb90543eb2967250331694e7aea03dc339f3b46809382f0c659951f6dae0b557da014a73e2eb8e10194f424bdafd86ad6c89cf90b9849fe19aeca38c9668512eac6a2"
    expected_3 = ""
    expected = expected_1 if GRAVITY_c == 1 else expected_3
