...
def pors_gensk_test():
    ...
    print(len(w.k) * HASH_SIZE)
    if hash_to_bytes(w.k[0]).hex() != "148161be7b61a6c76fef7eaebd34142848cdb7f940d68f99df3b95bd67190699":
    ...
    if list_of_hashes_to_bytes(w.k[
        ...
        raise Exception("Test failed")
    if hash_to_bytes(w.k[-1]).hex() != "dc66f958853c0145a6fa96a72877a54429f5fc1530ab42ce792c8a2d81c20890":
        raise Exception("Test failed")
    return w
